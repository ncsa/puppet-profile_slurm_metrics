# @summary Configure the telegraf collection script slurm_job_efficiency
#
# @param enable
...
class profile_slurm::telegraf::slurm_job_efficiency (
  Boolean $enable,
  String $interval,
  String $timeout,
){

  $script_base_name = 'slurm_job_efficiency'
